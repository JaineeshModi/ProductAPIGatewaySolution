...
3. Generate dev JWT Token: (If you need to create new Token, however current token Expires on 2026-05-19)
...
Override env var files for production use case
   ERP system URL, Warehouse system URL and JWT Authority
